...
# load save model
model = pickle.load(open('penyakit_jantung.sav', 'wb'))  # Ensure to replace 'diabetes_model.sav' with your actual model file
...
with col1 :
    restech = st.number_input('Hasil Elektrokadiografi')
with col2 :
...
# codevfor for prediction
heart_diagnosis =''

# membuat tombol prediksi
if st.button('Prediksi Penyakit Jantung'):
    heart_prediction = model.predict([[age, sex, cp, trestbps, chol, fbs, restech, thalach, exang, oldpeak, slope, ca, thal]])
